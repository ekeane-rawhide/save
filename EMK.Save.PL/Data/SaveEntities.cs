...
namespace EMK.Save.PL.Data
{
    ...
    {
        // ── Seed ID arrays ────────────────────────────────────────────────────
        private Guid[] userId          = new Guid[2];
        private Guid[] categoryId      = new Guid[8];
        private Guid[] budgetId        = new Guid[8];
        private Guid[] plaidAccountId  = new Guid[2];
        private Guid[] transactionId   = new Guid[10];
        private Guid[] snapshotId      = new Guid[2];
        private Guid[] summaryId       = new Guid[8];
        private Guid[] cashFlowId      = new Guid[5];
        ...
        private void CreateUsers(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblUser>(entity =>
            {
                ...
                entity.Property(e => e.Email)
                    .IsRequired().HasMaxLength(150).IsUnicode(false);
                entity.Property(e => e.Password)
                    .IsRequired().HasMaxLength(28).IsUnicode(false);
                entity.Property(e => e.TimeZone)
                    .IsRequired().HasMaxLength(50).IsUnicode(false);
                entity.Property(e => e.CurrencyCode)
                    .IsRequired().HasMaxLength(3).IsUnicode(false);
            ...
            modelBuilder.Entity<tblUser>().HasData(
                new tblUser
                {
                    ...
                    FirstName      = "Demo",
                    LastName       = "User",
                    Email          = "demo@emksave.com",
                    Password       = GetHash("demo123"),
                ...
                new tblUser
                {
                    ...
                    FirstName      = "Other",
                    LastName       = "Other",
                    Email          = "other@emksave.com",
                    Password       = GetHash("other123"),
                    TimeZone       = "America/Chicago",
                    CurrencyCode   = "USD",
                    DateRegistered = new DateTime(2024, 1, 1)
                }
        ...
        private void CreateBudgetCategories(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblBudgetCategory>(entity =>
            {
                ...
                entity.Property(e => e.Name)
                    .IsRequired().HasMaxLength(100).IsUnicode(false);
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK_tblBudgetCategory_UserId");
            });

            modelBuilder.Entity<tblBudgetCategory>().HasData(
                new tblBudgetCategory { Id = categoryId[0], UserId = userId[0], Name = "Housing",       Icon = "ti-home",          Color = "#2a78d6", CategoryType = 1, SortOrder = 1, IsActive = true },
                new tblBudgetCategory { Id = categoryId[1], UserId = userId[0], Name = "Groceries",     Icon = "ti-shopping-cart", Color = "#1baf7a", CategoryType = 1, SortOrder = 2, IsActive = true },
                new tblBudgetCategory { Id = categoryId[2], UserId = userId[0], Name = "Dining Out",    Icon = "ti-tools-kitchen", Color = "#eda100", CategoryType = 1, SortOrder = 3, IsActive = true },
                new tblBudgetCategory { Id = categoryId[3], UserId = userId[0], Name = "Transport",     Icon = "ti-car",           Color = "#4a3aa7", CategoryType = 1, SortOrder = 4, IsActive = true },
                new tblBudgetCategory { Id = categoryId[4], UserId = userId[0], Name = "Entertainment", Icon = "ti-device-tv",     Color = "#e34948", CategoryType = 1, SortOrder = 5, IsActive = true },
                new tblBudgetCategory { Id = categoryId[5], UserId = userId[0], Name = "Healthcare",    Icon = "ti-heart",         Color = "#e87ba4", CategoryType = 1, SortOrder = 6, IsActive = true },
                new tblBudgetCategory { Id = categoryId[6], UserId = userId[0], Name = "Savings",       Icon = "ti-piggy-bank",    Color = "#008300", CategoryType = 2, SortOrder = 7, IsActive = true },
                new tblBudgetCategory { Id = categoryId[7], UserId = userId[0], Name = "Income",        Icon = "ti-wallet",        Color = "#1baf7a", CategoryType = 0, SortOrder = 0, IsActive = true }
            );
        }
        ...
        private void CreateBudgets(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblBudget>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_tblBudget_UserId");
            ...
            modelBuilder.Entity<tblBudget>().HasData(
                new tblBudget { Id = budgetId[0], UserId = userId[0], CategoryId = categoryId[0], Month = month, Year = year, PlannedAmount = 1500m, RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[1], UserId = userId[0], CategoryId = categoryId[1], Month = month, Year = year, PlannedAmount = 400m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[2], UserId = userId[0], CategoryId = categoryId[2], Month = month, Year = year, PlannedAmount = 200m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[3], UserId = userId[0], CategoryId = categoryId[3], Month = month, Year = year, PlannedAmount = 250m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[4], UserId = userId[0], CategoryId = categoryId[4], Month = month, Year = year, PlannedAmount = 100m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[5], UserId = userId[0], CategoryId = categoryId[5], Month = month, Year = year, PlannedAmount = 150m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[6], UserId = userId[0], CategoryId = categoryId[6], Month = month, Year = year, PlannedAmount = 500m,  RolloverAmount = 0m, Notes = "" },
                new tblBudget { Id = budgetId[7], UserId = userId[0], CategoryId = categoryId[7], Month = month, Year = year, PlannedAmount = 5000m, RolloverAmount = 0m, Notes = "Monthly salary" }
            );
        }
        ...
        {
            for (int i = 0; i < plaidAccountId.Length; i++) plaidAccountId[i] = Guid.NewGuid();
            ...
            modelBuilder.Entity<tblPlaidAccount>(entity =>
            {
                ...
                entity.Property(e => e.Mask)
                    .IsRequired().HasMaxLength(4).IsUnicode(false);
            ...
            // Seed uses placeholder values — real tokens come from Plaid Link at runtime
            modelBuilder.Entity<tblPlaidAccount>().HasData(
                new tblPlaidAccount
                {
                    Id = plaidAccountId[0], UserId = userId[0],
                    PlaidAccountId = "demo_checking_001", PlaidItemId = "demo_item_001",
                ...
                new tblPlaidAccount
                {
                    Id = plaidAccountId[1], UserId = userId[0],
                    PlaidAccountId = "demo_savings_001", PlaidItemId = "demo_item_001",
                    AccessTokenEncrypted = "DEMO_ENCRYPTED_TOKEN",
                    InstitutionName = "First National Bank", InstitutionLogoUrl = "",
        ...
        {
            for (int i = 0; i < transactionId.Length; i++) transactionId[i] = Guid.NewGuid();
            ...
            modelBuilder.Entity<tblTransaction>(entity =>
            {
                ...
                entity.HasIndex(e => e.PlaidTransactionId)
                    .IsUnique().HasDatabaseName("UX_tblTransaction_PlaidTransactionId");
            ...
            modelBuilder.Entity<tblTransaction>().HasData(
                new tblTransaction { Id = transactionId[0], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[0], PlaidTransactionId = "txn_001", TransactionDate = d.AddDays(0),  MerchantName = "Rent Payment",       Description = "Monthly rent",        Amount = -1500m, IsoCurrencyCode = "USD", PlaidCategory = "Payment",         PlaidSubcategory = "Rent",         Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[1], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[1], PlaidTransactionId = "txn_002", TransactionDate = d.AddDays(2),  MerchantName = "Whole Foods",         Description = "Grocery shopping",    Amount = -127m,  IsoCurrencyCode = "USD", PlaidCategory = "Food and Drink",  PlaidSubcategory = "Supermarkets", Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[2], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[2], PlaidTransactionId = "txn_003", TransactionDate = d.AddDays(3),  MerchantName = "Chipotle",            Description = "Lunch",               Amount = -14m,   IsoCurrencyCode = "USD", PlaidCategory = "Food and Drink",  PlaidSubcategory = "Restaurants",  Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[3], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[3], PlaidTransactionId = "txn_004", TransactionDate = d.AddDays(4),  MerchantName = "Shell Gas Station",   Description = "Fuel",                Amount = -62m,   IsoCurrencyCode = "USD", PlaidCategory = "Travel",          PlaidSubcategory = "Gas Stations", Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[4], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[4], PlaidTransactionId = "txn_005", TransactionDate = d.AddDays(5),  MerchantName = "Netflix",             Description = "Streaming",           Amount = -18m,   IsoCurrencyCode = "USD", PlaidCategory = "Service",         PlaidSubcategory = "Subscription", Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[5], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[7], PlaidTransactionId = "txn_006", TransactionDate = d.AddDays(0),  MerchantName = "Employer Direct Dep", Description = "Payroll",             Amount = 5000m,  IsoCurrencyCode = "USD", PlaidCategory = "Payroll",         PlaidSubcategory = "Payroll",      Notes = "", IsExcluded = false, IsPending = false, IsReviewed = true  },
                new tblTransaction { Id = transactionId[6], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[1], PlaidTransactionId = "txn_007", TransactionDate = d.AddDays(7),  MerchantName = "Trader Joe's",        Description = "Grocery shopping",    Amount = -89m,   IsoCurrencyCode = "USD", PlaidCategory = "Food and Drink",  PlaidSubcategory = "Supermarkets", Notes = "", IsExcluded = false, IsPending = false, IsReviewed = false },
                new tblTransaction { Id = transactionId[7], PlaidAccountId = plaidAccountId[0], CategoryId = null,          PlaidTransactionId = "txn_008", TransactionDate = d.AddDays(8),  MerchantName = "Amazon",              Description = "Online purchase",     Amount = -43m,   IsoCurrencyCode = "USD", PlaidCategory = "Shopping",        PlaidSubcategory = "Online",       Notes = "", IsExcluded = false, IsPending = false, IsReviewed = false },
                new tblTransaction { Id = transactionId[8], PlaidAccountId = plaidAccountId[0], CategoryId = null,          PlaidTransactionId = "txn_009", TransactionDate = d.AddDays(9),  MerchantName = "Starbucks",           Description = "Coffee",              Amount = -7m,    IsoCurrencyCode = "USD", PlaidCategory = "Food and Drink",  PlaidSubcategory = "Coffee Shop",  Notes = "", IsExcluded = false, IsPending = true,  IsReviewed = false },
                new tblTransaction { Id = transactionId[9], PlaidAccountId = plaidAccountId[0], CategoryId = categoryId[5], PlaidTransactionId = "txn_010", TransactionDate = d.AddDays(10), MerchantName = "CVS Pharmacy",        Description = "Pharmacy",            Amount = -38m,   IsoCurrencyCode = "USD", PlaidCategory = "Medical",         PlaidSubcategory = "Pharmacies",   Notes = "", IsExcluded = false, IsPending = false, IsReviewed = false }
            );
        }
        ...
        {
            for (int i = 0; i < snapshotId.Length; i++) snapshotId[i] = Guid.NewGuid();
            ...
            modelBuilder.Entity<tblMonthlySnapshot>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_tblMonthlySnapshot_UserId");
            });

            modelBuilder.Entity<tblMonthlySnapshot>().HasData(
                new tblMonthlySnapshot { Id = snapshotId[0], UserId = userId[0], Month = 5, Year = 2025, TotalIncome = 5000m, TotalExpenses = 2650m, TotalBudgeted = 3100m, TotalSavings = 500m, TransactionCount = 42, OverBudgetCategoryCount = 1, SnapshotDate = new DateTime(2025, 6, 1) },
                new tblMonthlySnapshot { Id = snapshotId[1], UserId = userId[0], Month = 6, Year = 2025, TotalIncome = 5000m, TotalExpenses = 2920m, TotalBudgeted = 3100m, TotalSavings = 500m, TransactionCount = 38, OverBudgetCategoryCount = 2, SnapshotDate = new DateTime(2025, 7, 1) }
            );
        }
        ...
        private void CreateCategorySummaries(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblCategorySummary>().HasData(
        ...
        {
            for (int i = 0; i < cashFlowId.Length; i++) cashFlowId[i] = Guid.NewGuid();
            ...
            modelBuilder.Entity<tblCashFlowEntry>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_tblCashFlowEntry_UserId");
            });

            var d = new DateTime(year, month, 1);
            modelBuilder.Entity<tblCashFlowEntry>().HasData(
                new tblCashFlowEntry { Id = cashFlowId[0], UserId = userId[0], EntryDate = d,            DayIncome = 5000m, DayExpenses = 1500m, RunningBalance = 3500m, ProjectedBalance = 3500m, TransactionCount = 2 },
                new tblCashFlowEntry { Id = cashFlowId[1], UserId = userId[0], EntryDate = d.AddDays(2),  DayIncome = 0m,    DayExpenses = 127m,  RunningBalance = 3373m, ProjectedBalance = 3373m, TransactionCount = 1 },
                new tblCashFlowEntry { Id = cashFlowId[2], UserId = userId[0], EntryDate = d.AddDays(3),  DayIncome = 0m,    DayExpenses = 14m,   RunningBalance = 3359m, ProjectedBalance = 3359m, TransactionCount = 1 },
                new tblCashFlowEntry { Id = cashFlowId[3], UserId = userId[0], EntryDate = d.AddDays(4),  DayIncome = 0m,    DayExpenses = 62m,   RunningBalance = 3297m, ProjectedBalance = 3297m, TransactionCount = 1 },
                new tblCashFlowEntry { Id = cashFlowId[4], UserId = userId[0], EntryDate = d.AddDays(5),  DayIncome = 0m,    DayExpenses = 18m,   RunningBalance = 3279m, ProjectedBalance = 2800m, TransactionCount = 1 }
            );
        }
        ...
        private void CreateTrackingInsights(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblTrackingInsight>(entity =>
            {
                ...
                entity.Property(e => e.Title).IsRequired().HasMaxLength(200).IsUnicode(false);
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_tblTrackingInsight_UserId");
            ...
            modelBuilder.Entity<tblTrackingInsight>().HasData(
                new tblTrackingInsight { Id = insightId[0], UserId = userId[0], Month = month, Year = year, InsightType = 0, Severity = 2, CategoryId = categoryId[2], Title = "Dining Out over budget", Message = "You've spent $60 more than planned on dining this month.", Amount = 60m, ChangePercent = 30.0, GeneratedOn = DateTime.Today, IsDismissed = false, IsRead = false },
                new tblTrackingInsight { Id = insightId[1], UserId = userId[0], Month = month, Year = year, InsightType = 7, Severity = 1, CategoryId = null,          Title = "2 unassigned transactions", Message = "You have 2 transactions that haven't been assigned to a budget category.", Amount = null, ChangePercent = null, GeneratedOn = DateTime.Today, IsDismissed = false, IsRead = false },
                new tblTrackingInsight { Id = insightId[2], UserId = userId[0], Month = month, Year = year, InsightType = 1, Severity = 1, CategoryId = categoryId[1], Title = "Groceries on track", Message = "You're spending less on groceries than last month — great job!", Amount = null, ChangePercent = -5.0, GeneratedOn = DateTime.Today, IsDismissed = false, IsRead = false }
            );
        }
        ...
        private void CreatePushNotifications(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblPushNotification>(entity =>
            {
                ...
                entity.Property(e => e.Title).IsRequired().HasMaxLength(200).IsUnicode(false);
                entity.Property(e => e.Body).IsRequired().HasMaxLength(500).IsUnicode(false);
                entity.Property(e => e.Icon).IsRequired().HasMaxLength(200).IsUnicode(false);
                entity.Property(e => e.ActionUrl).IsRequired().HasMaxLength(500).IsUnicode(false);
                entity.Property(e => e.PushEndpoint).IsRequired().HasMaxLength(500).IsUnicode(false);
                entity.Property(e => e.Amount).HasColumnType("decimal(18,2)");
                entity.Property(e => e.SentOn).HasColumnType("datetime");
                entity.Property(e => e.ScheduledFor).HasColumnType("datetime");
                entity.Property(e => e.ErrorMessage).IsRequired().HasMaxLength(500).IsUnicode(false);
        ...
        private void CreateNotificationPreferences(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblNotificationPreference>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserId)
                    .IsUnique().HasDatabaseName("UX_tblNotificationPreference_UserId");

                entity.Property(e => e.PushEndpoint).IsRequired().HasMaxLength(500).IsUnicode(false);
                entity.Property(e => e.P256dhKey).IsRequired().HasMaxLength(200).IsUnicode(false);
                entity.Property(e => e.AuthKey).IsRequired().HasMaxLength(100).IsUnicode(false);
            ...
            modelBuilder.Entity<tblNotificationPreference>().HasData(
